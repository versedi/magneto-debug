...
$adapterInterface = $installer->getConnection();
if (!$adapterInterface->isTableExists($installer->getTable('sheep_debug/request_info'))) {
    $table = $adapterInterface->newTable($installer->getTable('sheep_debug/request_info'))
